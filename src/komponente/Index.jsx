export default function Index() {
    return (
        ...
        >
            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img className="d-block w-100" src="/1.svg" alt="First slide"/>
                </div>
                <div className="carousel-item">
                    <img className="d-block w-100" src="/2.svg" alt="Second slide"/>
                </div>
                <div className="carousel-item">
        ...
        <div className="container-fluid normalText p-4">
                ...
                schulisch wie auch persöhnliche, finden können. Falls Sie von meinen Projekten, meinen Kenntnissen und
